...
<div class="row row-cards" id="larametricsLogs">
    <div class="col-12">
        <div class="btn-list" style="margin-bottom:0.75rem">
            <a href="#" class="btn btn-secondary" :class="{'disabled': typeof logsPaginated[page - 1] == 'undefined'}" @click.prevent="page = (page - 1)">Prev</a>
            ...
            <a href="#" class="btn btn-secondary" :class="{'disabled': typeof logsPaginated[page + 1] == 'undefined'}" @click.prevent="page = (page + 1)">Next</a>
        </div>
        <div class="card">
